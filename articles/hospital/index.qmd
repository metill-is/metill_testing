...
```{r}
d <- read_csv2(here("articles", "hospital", "landspitali.csv"))
...
lands_laun <- read_csv(here("articles", "hospital", "landspitali_laun.csv")) |> 
...
knitr::include_graphics(here("articles", "hospital", "veikindi_kjarnar.png"))
```
...
ggsave(
  ...
  filename = here("articles", "hospital", "hjukthyngd.png"),
  width = 8, 
  height = 0.621 * 8, 
  scale = 1
)
...
ggsave(
  plot = p + 
    ...
    labs(subtitle = "Súlur sýna dreifingu (vinstri ás) og lína sýnir meðalþyngd legudaga (hægri ás)"),
  filename = here("articles", "hospital", "hjukthyngd_fp.png"),
  width = 8, 
  height = 0.621 * 8, 
  scale = 1
)
...
knitr::include_graphics(here("articles", "hospital", "skrifstof_landsp.png"))
```
...
```{r}
d <- read_csv(here("articles", "hospital", "data.csv")) |> 
  mutate(text = str_c("Ár: ", ar, "\n",
