...
Nýjasta könnun í spánni eru kannanir Gallup og Prósent sem voru birtar 15. nóvember
...
Hér að ofan má sjá matið okkar á mögulegum úrslitum kosninganna. Til að forðast ímynd um meiri vissu en er til staðar námundum við fylgið í næstu heiltölu. Vegna þess geta tölur í töflunni hækkað eða lækkað þótt matið á fylgi hafi breyst lítið. Sömuleiðis getur summa alls fylgis verið önnur en 100%.
...
tribble(
  ...
  "Gallup", "1. nóv", "14. nóv", "7. nóv",
  "Maskína", "8. nóv", "13. nóv", "10. nóv",
  "Prósent", "8. nóv", "14. nóv", "11. nóv"
) |> 
  gt() |> 
  cols_align(
    columns = -1,
